...
Original file is located at
    https://colab.research.google.com/drive/1MKYbTe5SZDMBN-HzkW-fPbpQwiWHDbcR
"""
...
# ═══════════════════════════════════════════════════════════════════════
    ...
    styled = df_req.style.applymap(color_priority, subset=["Prioridad"])
...
# ═══════════════════════════════════════════════════════════════════════
    ...
    st.dataframe(df_res.style.applymap(color_status, subset=["Estado"]),
